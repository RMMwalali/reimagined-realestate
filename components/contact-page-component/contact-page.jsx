...
const ContactPage = () => {
  ...
  return (
    <div className=" w-full overflow-hidden">
      <div className="  flex bg-[url(https://res.cloudinary.com/dtnbwgpca/image/upload/q_auto:best,f_auto/v1715938274/Patnan%20Web/kq6gt0utecwhswazyvg4.png)] pt-44 max-sm:pt-40 pb-32 bg-top bg-no-repeat bg-cover  ">
        <div
          style={{ maxWidth: 1200 }}
