...
const ServicesComponent = () => {
  return (
    <>
      <div className="bg-[url(https://res.cloudinary.com/dtnbwgpca/image/upload/q_auto:best,f_auto/v1715938274/Patnan%20Web/kq6gt0utecwhswazyvg4.png)] bg-fixed bg-center bg-cover pt-44 pb-36 max-md:pt-36 max-md:pb-24 ">
        <motion.div
          initial="initial"
          whileInView="animate"
